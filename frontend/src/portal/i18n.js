...
export const dict = {
  es: {
    ...
    new_message_one: '1 mensaje nuevo · toca para verlo',
    new_message_many: '{n} mensajes nuevos · toca para verlos',
    pdf_download: 'Descargar PDF',
    pdf_generating: 'Generando…',
    resend_prompt: '¿Perdiste el acceso a {code}? Te reenviamos el enlace a tu correo:',
    resend_btn: 'Enviar enlace',
    resend_sent: 'Si esa incidencia es tuya, te hemos enviado el enlace. Revisa tu correo.',
  ...
  en: {
    ...
    new_message_one: '1 new message · tap to view',
    new_message_many: '{n} new messages · tap to view',
    pdf_download: 'Download PDF',
    pdf_generating: 'Generating…',
    resend_prompt: 'Lost access to {code}? We can resend the link to your email:',
    resend_btn: 'Send link',
    resend_sent: 'If that ticket is yours, we have emailed you the link. Check your inbox.',
  ...
  pt: {
    ...
    new_message_one: '1 mensagem nova · toque para ver',
    new_message_many: '{n} mensagens novas · toque para ver',
    pdf_download: 'Descarregar PDF',
    pdf_generating: 'A gerar…',
    resend_prompt: 'Perdeu o acesso a {code}? Reenviamos o link para o seu correio:',
    resend_btn: 'Enviar link',
    resend_sent: 'Se essa incidência é sua, enviámos-lhe o link por correio. Verifique a caixa de entrada.',
    otp_box_aria: 'Dígito {n} de 6',
    chars: '{n} caracteres',
    remove: 'Remover',
